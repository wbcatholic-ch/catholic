...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V4-106';
...
const _PARISH_ASSET_VERSION='V4-106';
...
const _PRAYER_ASSET_VERSION='V4-106';
...
const _RETREAT_ASSET_VERSION='V4-106';
...
const _SHRINE_ASSET_VERSION='V4-106';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
