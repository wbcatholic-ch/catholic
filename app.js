...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V4-107';
...
const _PARISH_ASSET_VERSION='V4-107';
...
const _PRAYER_ASSET_VERSION='V4-107';
...
const _RETREAT_ASSET_VERSION='V4-107';
...
const _SHRINE_ASSET_VERSION='V4-107';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
