...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V6-28';
...
const _PARISH_ASSET_VERSION='V6-28';
...
const _PRAYER_ASSET_VERSION='V6-28';
...
const _RETREAT_ASSET_VERSION='V6-28';
...
const _SHRINE_ASSET_VERSION='V6-28';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
