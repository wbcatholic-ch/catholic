...
function openDioceseView(opts){
  ...
  if(needsLoad){
    ...
    frame.src='diocese.html?v=V3-123';
  }else if(!restore){
...
const _PARISH_ASSET_VERSION='V3-123';
...
const _PRAYER_ASSET_VERSION='V3-123';
...
const _SHRINE_ASSET_VERSION='V3-123';
let SHRINES = [];
let JUKRIMGUL_IDX = -1;
